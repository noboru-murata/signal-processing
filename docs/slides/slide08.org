...
# Time-stamp: <2026-06-19 10:42:45 mura>
:REVEAL:
...
#+name: fig:contour_integral1
#+attr_html: :class r-stretch :width 120%
#+attr_latex: :width 0.5\linewidth
[[file:figs/contour_integral1.png]]
...
- エレキギターのエフェクター (effects unit, pedal)
   ...
   #+end_quote
** 参考
https://www.watercoursestudio.com/a-primer-on-guitar-effects/
