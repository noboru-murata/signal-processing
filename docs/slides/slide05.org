...
#+DATE:
# Time-stamp: <2021-05-07 08:54:31 mura>
:reveal:
...
** 解答例
   ...
   #+begin_src R :file figs/fourier_step.png :exports results :results graphics
   ...
   #+end_src
   # #+CAPTION: Fourier 級数
   #+NAME: fig:fourier_step
   #+ATTR_HTML: :height 100%
   #+ATTR_LATEX: :width 0.6\linewidth
   [[file:figs/fourier_step.png]]
