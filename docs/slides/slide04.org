...
# Time-stamp: <2026-05-07 13:42:39 mura>
:REVEAL:
...
** ベクトル空間
- 満たすべき条件
   #+attr_html: :class callout-important :style font-size: 1em!important;
...
- 内積の定義
   ...
   *内積*
   という．
   #+attr_html: :style font-size: 1em!important;   
...
- step 11
   ...
   - 第2項では \(f(x-y)-f(x)\) をいくらでも小さくすることができる
   この結果，\(\delta\) と \(r\) とを適当に選ぶことによって
   3つの積分の和はいくらでも小さくなる．
   #+end_quote
