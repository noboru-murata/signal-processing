...
#+DATE:
# Time-stamp: <2021-06-02 18:33:41 mura>
:reveal:
...
** 練習問題
   ...
   - 関数
     ...
     #+end_src
     の Fourier 変換を求めよ．
     - /[[color:gray][Fourier 変換と逆 Fourier 変換の関係を利用]]/
     - 複素積分を利用
** COMMENT 解答例
   :PROPERTIES:
   :reveal_background: #fef4f4
...
** フィルタの例
   - [[color:darkgreen][エレキギターのエフェクター]] (effects unit, pedal)
